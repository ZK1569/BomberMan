...
void init_game(Game *game)
{
    ...
    load_map(&game->map, "../Code/graphical/levels/level_01.txt");
    load_texture(game, "../Code/graphical/assets/NES_BOMBERMAN.png");
    load_font(game, "../Code/graphical/assets/Monocraft.ttf");
...
void process_input(Game *game)
{
    SDL_Event event;
    SDL_PollEvent(&event);
    GamePlayer *current_player = &game->players[0];
